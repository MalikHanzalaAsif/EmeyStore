...
const Product = () => {
    ...
    const addToCartFunc = () => {
        ...
        toastEmitter({title: "item added to cart", type: "success", navigate: navigate});
    }
    return currProduct ? (
        <section className = "py-8 bg-white md:py-16 dark:bg-gray-900 antialiased mt-32" >
                    <div className="max-w-screen-xl px-4 mx-auto 2xl:px-0">
                        <div className="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">
                            <div className="shrink-0 max-w-md lg:max-w-lg mx-auto flex justify-center">
                                <img className="w-72 dark:hidden h-auto" src={currProduct.image} alt={currProduct.title} />
                            </div>
